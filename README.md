...
- Lamas Moncada Selena Dulce ([@whenlenafallsinlove](https://github.com/whenlenafallsinlove)) - Desarrollador
...
No se trata de competir por ego.
Se trata de aprender a construir sistemas excelentes.
...
Si tu estructura depende de raylib directamente, está mal diseñada.
Si el modelo conoce la vista, está mal diseñado.
Si no podés testear algo en aislamiento, está mal diseñado.
...
En 2077, los sistemas no perdonan la ineficiencia.
Y el software real tampoco.

Compilá con cuidado.
Medí todo.
Pensá antes de codear.
