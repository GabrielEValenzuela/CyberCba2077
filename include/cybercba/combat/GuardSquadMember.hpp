...
class GuardSquadMember
{
  public:
    ...
    */
     ...
     */
    [[nodiscard]] const cybercba::structures::DynamicArray<std::size_t>& vecinos() const;
    ...
    * @param state Estado actual del combate.
